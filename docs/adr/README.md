...
| [0004](0004-primary-research-contribution.md) | Training-first compact learned VIO development slice | Accepted | EuRoC ingestion, training, held-out development evaluation; confirmatory claims remain later |
...
execute a real dataset/calibration/model-training workflow. Its earlier
